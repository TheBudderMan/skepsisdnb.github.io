document.addEventListener('DOMContentLoaded', () => {
  const routes = {
    ...
    'music':  { template: 'music.html',   title: 'Music',   description: 'Listen to Formant’s sound design and original compositions across platforms.' },
    'contact':{ template: 'contact.html', title: 'Contact', description: 'Contact Tyler Johnston-Kent — digital artist, developer, and music producer.' },
    '404':    { template: '404.html',     title: '404',     description: 'Page not found' }
  };
